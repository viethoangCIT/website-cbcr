...
<div class="">
            ...
            <tr>
              ...
              <td class='mid' colspan ="3" style="padding: 0px !important;">
                <table style="width: 200px;  margin: 0px; height:90px; border-collapse: collapse; border-color: #ddd; border-top:  0px; border-bottom: 0px; border-left: 0px; border-right: 0px" border="1">
                  ...
                  if($data["data"]["tmp"] != "") 
                  {
                    $str_data_nhietdo .= "\"". $data['data']['tmp']. "\",";
                    $label_time_nhietdo .= "\"". $data['data']['time']. "\",";
                    ?>
        ...
        <?php 
          ...
          // BEGIN: NẾU DÒNG HIỆN TẠI LÀ LƯỢNG MƯA
            ...
            { 
              ...
              $str_data_luongmua .= "\"". $data['data']['rain']. "\",";
              $label_time_mua .= "\"". $data['data']['time']. "\",";
              ?>
              <tr>
  ...
  <div class="pagination">
    ...
    $next= $page+1;
    if($next>$tongso_trang) $next = $tongso_trang;
    ?>
    <a href="" onclick = "previous(<?php echo $previous;?>)" class="page">Previous</a>
    <?php 

    for($i=1; $i<=$tongso_trang; $i++)
    {

      ?>
      <a href="" onclick="page(<?php echo $i;?>)" class="page"><?php echo $i;?></a> 
    ...
    <a href=""  onclick = "previous(<?php echo $next;?>)" class="page">Next</a>
  </div>
  <!--END: PHÂN TRANG-->
...
<?php
    ...
    //đảm bảo giá trị trục tung lớn hơn 0
    if($min_luongmua < 1) $min_luongmua = 1;
    if($max_luongmua <1) $max_luongmua = 1;
?>
 //begin vi du
 var config_nhietdo = {
  type: 'line',
        ...
        var config_luongmua = {
          ...
          options: {
            ...
            scales: {
              yAxes: [{
                ticks: {
                  min: <?php echo $min_rain - 5; ?>,
                  max: <?php echo $max_rain + 5; ?>
                }
              }]
            }
          }
