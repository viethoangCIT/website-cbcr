        ...
        <div style="width:100%">
           <div class='container' style="padding:0px !important; ">
               <div class="col-lg-12" style="padding:0px !important;">
                <h1 class="wrap-logo" style="width:50%; float:left; height: 30px" >
          ...
          ?>
            ...
            <a href="" class="hello"> <?php echo $name; ?> </a>
          <?php } ?>
    </div>
</div>
</section>
<!-- TOP HEADER -->
<div id="top_menu">
    <div id="menu_mobile" onclick='_menu();' ><img src="<?php echo $this->webroot;?>img/icon/menu-icon-11.png" style="width:45px;"/>
    </div>
    <div id="div_tram_canh_bao_moblie">
       <form  id="form_tram">
        ...
        <div class='row' style="margin-left:0px; margin-right:0px">
            <nav class="navbar" style="font-size:20px; height:33px">
              <ul class="nav navbar-nav" style="width:100%;">
                  ...
                  <li style="border-right: 1px solid #d9d9d9; font-size:16px">
                   <?php  
                      $name = $this->Session->read('name');
                      if($name != "")
                      {
                    ?>
                  <a href="<?php echo $this->webroot;?>trangquantri" class="mau_menu" id="bando">Trang quản trị</a>
                  <?php } ?>
                  
                </li>
                  <li style="border-right: 1px solid #d9d9d9; font-size:16px; float:right;">
                  <?php  
                      $name = $this->Session->read('name');
                      if($name == "")
                      {
                    ?>
                    <a href="<?php echo $this->webroot;?>login.html" class="mau_menu" id="login">Đăng nhập</a>
                   ...
                   <?php 
                     ...
                     else
                     {
                      ...
                      {
                    ?>
                      <a href="/Login/logout" class="dangxuat" > Đăng Xuất </a>
                    <?php 
                       }
                      }
                     ?>
            ...
            <li class ="end " id = "canhbao" style="display:none; background-color: red">
              <a href="<?php echo $this->webroot;?>canhbao"  style="color:white; height: 51px;" target="_blank">Cảnh báo</a>
            </li>
            <li id = "canhbao1" style="display: none;">
            </li>
        </ul>	
      </nav>
  </div>
...
<br /><br /><br /><br />
<footer style="text-shadow:none;letter-spacing:0px ;left: 0;right: 0;bottom: 0;background-color:#f1f1f1;z-index:10;padding:10px 20px 10px 20px;margin-top:0px !important;font-family:inherit;font-size:13px;line-height:17px !important">
 ...
 <span style="color:#000 !important;"><b>CHI CỤC KIỂM LÂM ĐÀ NẴNG</b><span><br />
    <span style="color:#000 !important;font-size:12px">Địa chỉ: 02 Trần Cao Vân, Quận Hải Châu, Đà Nẵng<span><br />
        ...
        <audio id='myAudio'><source src='/audio/canhbao.mp3' type='audio/mpeg'></audio>
    ...
    <script>
        ...
        //BEGIN: HÀM KIỂM TRA BÁO CHÁY
        function kiemtra_baochay()
        {
            
            $.ajax({  method: "GET",  url: "/canhbao/kiemtra",  data: { name: "", location: "" }})
            .done(function( data ) {
        ...
        //END: kiemtra_baochay()
        //đối tượng chuông cảnh báo
        x = document.getElementById("myAudio");
        setInterval(kiemtra_baochay, 3000);
        </script>
    </body>
