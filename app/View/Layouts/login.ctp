...
<body>
	<div id='page'>
			...
			<div class='top_min'>
				...
				<p' class="user_mobile dropbtn" id="div-user" style="text-decoration: none; margin-top: 13px;font-weight: bold; font-size: 11px; ">
					 &nbsp;&nbsp; &nbsp; &nbsp;  Sơn Nguyễn
				</p> </h5>
                <div id="logout">
                    <a href="<?php echo $this->webroot;?>login.html">Đăng xuất</a>
                </div>
	...
	<footer style="text-shadow:none;letter-spacing:0px ;left: 0;right: 0;bottom: 0;position:absolute;background-color:#f1f1f1;z-index:10;padding:10px 20px 10px 20px;margin-top:0px !important;font-family:inherit;font-size:13px;line-height:17px !important">
        ...
        <script>
            ...
            function _menu(){
                ...
                function div_user()
				{
					// lấy tọa độ theo chữ user name
					
					 var txt = document.getElementById("div-user");
					var p = GetScreenCordinates(txt);
					
					//vị trí của logout
					document.getElementById("logout").style.left =(p.x + 45) +"px";
