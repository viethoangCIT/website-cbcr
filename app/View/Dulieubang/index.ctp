<h2 class='title_page'>DỮ LIỆU DẠNG BẢNG</h2>
  <div class='row' style="margin-left:0px; margin-right:0px">
      <form action="<?php echo $this->webroot;?>dulieubang" method="get" id="form_timkiem">
      ...
      <table data-role="table" id="movie-table" data-mode="reflow" class="ui-responsive table table-bordered table-striped" style='border-top:1px solid #dcdcdc; width:100%; display:inline-table'>
		...
		?>
          <tr class=' HoverTable' >
             ...
             <td class="mid"  >
                  <div class="chiso_phone"><?php echo $chiso; ?></div>
              </td>
              <td class='mid ' ><?php echo $gio." ".$ngay; ?></td>
           </tr>
           <?php 
			}
		 }else
